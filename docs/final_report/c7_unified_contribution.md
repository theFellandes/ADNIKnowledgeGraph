...
The contribution is a reproducible methodology that produces such a bridge for a real ADNI-derived multimodal KG (~542K nodes, ~1.3M relationships in the enhanced graph), evaluated quantitatively against a well-known reference KG.
